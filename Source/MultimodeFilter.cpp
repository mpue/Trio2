...
void MultimodeFilter::coefficients(float frequency, float resonance) {
    ...
    this->lowPassLeftStage1->coefficients( frequency, resonance);
    this->lowPassRightStage1->coefficients( frequency, resonance);

	this->lowPassLeftStage2->coefficients(frequency, resonance);
	this->lowPassRightStage2->coefficients(frequency, resonance);
